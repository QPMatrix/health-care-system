...
import CFormField, { FormFieldType } from "../custom/form-field";
import SubmitBtn from "../custom/submit-btn";
...
import FileUploader from "../uploads/file-upload";
      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CFormField
            ...
            name="address"
            label="Address"
            placeholder="Al-tayar street , Tamra Hazfon ,IL"
          />
          <CFormField
            fieldType={FormFieldType.INPUT}
            control={form.control}
        ...
        <CFormField
          ...
          label="I consent to disclose my information to the physician"
        />
        <CFormField
          fieldType={FormFieldType.CHECKBOX}
          control={form.control}
